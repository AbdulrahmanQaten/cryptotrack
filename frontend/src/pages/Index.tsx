...
import { TrendingUp, DollarSign, BarChart3, Coins, ArrowRight, Loader2 } from 'lucide-react';
...
const Index = () => {
  ...
  const gainers = cryptoData ? [...cryptoData].sort((a, b) => b.change24h - a.change24h).slice(0, 3) : [];
  const losers = cryptoData ? [...cryptoData].sort((a, b) => a.change24h - b.change24h).slice(0, 3) : [];
  ...
  return (
    <div className="page-container">
      ...
      <section className="text-center py-12 md:py-20">
        ...
        <Link to="/market">
          <Button size="lg" className="flat-button font-bold animate-fade-in" style={{ animationDelay: '0.2s' }}>
            {t('home.explore')}
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
        {isLoading ? (
          ...
          <>
            ...
            <StatCard
              title={t('home.coins')}
              value={(globalData?.active_cryptocurrencies || 0).toLocaleString()}
      ...
      <section className="mb-12">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/market" className="text-primary font-medium hover:underline flex items-center gap-1">
            {t('common.seeAll')}
        ...
        {cryptoLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {topCoins.map((crypto, index) => (
              <div key={crypto.id} className="animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>

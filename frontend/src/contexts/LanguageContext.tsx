...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.subtitle': 'Track cryptocurrency prices, market trends, and manage your portfolio in real-time',
    ...
    'market.subtitle': 'Explore all cryptocurrencies with real-time prices and market data',
    ...
    'portfolio.subtitle': 'Track your cryptocurrency investments and performance',
    ...
    'portfolio.addAssetDescription': 'Add a cryptocurrency to your portfolio to track its performance.',
    ...
    'wallet.subtitle': 'Track any wallet balance and transactions across multiple blockchains',
    ...
    'wallet.emptyDescription': 'Select a network and enter a wallet address above to view its balance and transactions',
    ...
    'transaction.emptyDescription': 'Select a network and enter a transaction hash above to view its details',
    
    // News
    'news.title': 'Crypto News',
    'news.subtitle': 'Stay updated with the latest blockchain and cryptocurrency news',
    'news.readMore': 'Read More',
    'news.latest': 'Latest News',
    
    // About
    'about.title': 'About Blockchain Tracker',
    'about.subtitle': 'Your comprehensive platform for cryptocurrency tracking and analysis',
    'about.mission': 'Our Mission',
    'about.missionText': 'To provide accurate, real-time cryptocurrency data and insights to help users make informed investment decisions.',
    ...
    'about.secureDesc': 'Your data is safe with industry-standard security practices.',
    'about.fast': 'Fast & Accurate',
    'about.fastDesc': 'Real-time data with minimal latency for accurate tracking.',
    'about.multilingual': 'Multilingual',
    'about.multilingualDesc': 'Available in English and Arabic with full RTL support.',
  ...
  ar: {
    ...
    'home.subtitle': 'تتبع أسعار العملات الرقمية واتجاهات السوق وإدارة محفظتك في الوقت الفعلي',
    ...
    'market.subtitle': 'استكشف جميع العملات الرقمية مع الأسعار الفورية وبيانات السوق',
    ...
    'wallet.subtitle': 'تتبع رصيد أي محفظة ومعاملاتها عبر شبكات بلوكتشين متعددة',
    ...
    'wallet.emptyDescription': 'اختر شبكة وأدخل عنوان محفظة أعلاه لعرض رصيدها ومعاملاتها',
    ...
    'transaction.emptyDescription': 'اختر شبكة وأدخل هاش المعاملة أعلاه لعرض تفاصيلها',
    ...
    'about.missionText': 'توفير بيانات ورؤى دقيقة وفورية للعملات الرقمية لمساعدة المستخدمين على اتخاذ قرارات استثمارية مدروسة.',
